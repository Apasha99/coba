...
@section('content')
    <div class="mb-4 col-span-full xl:mb-2">
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li class="inline-flex items-center">
                    <a href="{{route('instruktur.viewDetailPelatihan', ['plt_kode'=>$pelatihan->kode])}}"
                        class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
    ...
    <div class="sm:flex mb-4">
        <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
            <input type="text" id="searchInput" placeholder="Search for test" class="mt-2 mb-4 p-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"> 
        </div>
        <script>
        ...
        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
            <a href="{{route('rekap.download', $pelatihan->kode)}}"
                                    ...
                                    @foreach ($test as $tes)
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap ">
                                                <a href="{{route('rekap.detailRekap', [$pelatihan->kode, $tes->id])}}" class="text-blue-600 hover:text-blue-800 hover:underline">
                                                    Details
                                                </a>
                                            </td>
                                        </tr>
