...
@section('content')
    <div class="mb-4 col-span-full xl:mb-2">
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li class="flex items-center">
                    <a href="{{route('admin.detailTest', [$pelatihan->kode, $test->id])}}"
                        class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
    ...
    <div class="col-span-full xl:col-auto">
        <form action="{{ route('admin.storeSoal', [$pelatihan->kode, $test->id]) }}" method="post"  enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-full mt-4">
                                <button
                                    ...
                                    type="submit">Tambah Soal Test</button>
                            </div>
                        </div>
                </div>
            </div>
