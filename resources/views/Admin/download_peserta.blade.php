...
<head>
    <meta charset="UTF-8">
    <title>Daftar Akun Peserta Diskominfo</title>
...
<body>
    ...
    <div class="container-lg">
        <div class="mb-4 col-span-full xl:mb-2">
            <h3>Daftar Akun Peserta Pelatihan</h3>
        </div>

        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
            <thead class="bg-blue-500 text-white"> <!-- Mengatur warna latar belakang dan teks untuk header -->
                <tr>
                    <th scope="col" class="p-2 text-m font-large tracking-wider text-center">
                        ID
                    </th>
                    <th scope="col" class="p-2 text-l font-large tracking-wider text-center">
                        Nama
                    </th>
                    <th scope="col" class="p-2 text-l font-large tracking-wider text-center">
                        Username
            ...
            <tbody class="bg-white"> <!-- Mengatur warna latar belakang untuk isi tabel -->
                ...
                <tr>
                    ...
                    <td class="p-2 text-sm text-center font-semibold text-gray-900 whitespace-nowrap">
                        {{ $pst->nama }}
                    </td>
                    <td class="p-2 text-sm text-center font-normal text-gray-500 whitespace-nowrap">
                        {{ $pst->username }}
                    </td>
                    <td class="p-2 text-sm text-center font-normal text-gray-500 whitespace-nowrap">
                        {{ $pst->email }}
