...
<body class="bg-gray-50 dark:bg-gray-800">
    <div class="grid grid-cols-5">
        ...
        <div class="col-span-4">
            <nav class="bg-indigo-100 border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            ...
            <div id="main-content" class="overflow-y-auto bg-gray-50 dark:bg-gray-900">
                <main>
                    <div class="w-full flex justify-center top-0">
                        @if (session('success'))
                            <div id="alert-1"
    ...
    <script>
            // Fungsi untuk menyesuaikan posisi navbar
        function adjustNavbarPosition(isFullscreen) {
            const navbar = document.querySelector('nav');

            // Jika dalam mode fullscreen, tambahkan kelas left-64, jika tidak, hapus kelas tersebut
            ...
            // Listener untuk mendeteksi perubahan status fullscreen
            document.addEventListener('fullscreenchange', adjustNavbarPosition);
    </script>
