                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <a href="/admin/dashboard"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Request::is('admin/dashboard') ? 'bg-purple-500 text-white' : '' }}">
                            ...
                            <li class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <a href="{{ route('admin.viewDaftarPelatihan') }}"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Request::is('admin/daftar-pelatihan') ? 'bg-purple-500 text-white' : '' }}">
