                        ...
                        <h3 class="mb-4 text-xl font-semibold dark:text-white">Data Peserta</h3>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-full mt-4 flex justify-end items-center">
                                    <a href="{{ route('admin.viewDaftarPeserta') }}"class="mr-4 text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                                        Batal
                                    </a>
