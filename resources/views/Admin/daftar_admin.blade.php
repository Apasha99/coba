...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Daftar Admin</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="sm:flex mb-4">
        ...
        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
            ...
            <a data-modal-toggle="export-admin-modal"
                                        ...
                                        @foreach ($admin2 as $plt)
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap ">
                                                    @if($plt && $plt->admin_id)
                                                    <a href="{{route('admin.editAdmin', $plt->admin_id)}}" data-tooltip-target="tooltip-toggle-edit" class="inline-flex items-center px-2 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                                    ...
                                                    @endif
                                                    <button type="button" data-tooltip-target="tooltip-toggle-delete" data-modal-toggle="delete-admin-modal-{{ $plt->admin_id }}"
        ...
        <div class="relative w-50 h-50 max-w-2xl px-4 md:h-50">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 overflow">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    ...
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-toggle="export-admin-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
                ...
                <div class="p-6 space-y-6 overflow-y-auto">
                    ...
                    <form id="exportForm" method="GET" action="{{ route('admin.downloadAdmin') }}">
                        @csrf
                        <div class="col-span-full justify-between items-center">
                            ...
                            <div class=" mt-2 justify-between items-center space-x-4">
                                ...
                                <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" data-modal-toggle="export-admin-modal">
                                    Batal
                                </button>
                            </div>
                        </div>
