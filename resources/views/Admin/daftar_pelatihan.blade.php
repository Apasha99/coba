        ...
        <div class="col-span-full xl:col-auto">
            <div class="flex items-center sm:space-x-3 justify-between">
                <a type="button" href="{{route('admin.addPelatihan')}}"
                    class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    <svg class="w-6 h-6 mr-2 -ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                    ...
                    <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4 ">
                        <div class="sm:w-60 md:w-80">
                            ...
                            <div class="mb-4 text-sm text-gray-500 dark:text-gray-400 searchable">
                                ...
                                <div class="relative lock float-right p-2">
                                    @if($plt && $plt->id)
                                    <a href="{{ route('admin.editPelatihan', $plt->id) }}" data-tooltip-target="tooltip-toggle-edit" class="inline-flex items-center px-2 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                    ...
                                    @endif
                                    <button type="button" data-modal-toggle="delete-pelatihan-modal-{{ $plt->kode }}" data-tooltip-target="tooltip-toggle-delete"
