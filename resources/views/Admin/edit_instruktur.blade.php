...
@section('content')
    ...
    <div class="col-span-full xl:col-auto">
        <form action="{{ route('admin.updateInstruktur', $instruktur->user_id) }}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <h3 class="mb-4 text-xl font-semibold dark:text-white">Data Instruktur</h3>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="id" placeholder="id" id="id" value="{{ $instruktur->user_id }}" disabled
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="username" placeholder="username" id="username" value="{{ $instruktur->username }}"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        @error('username')
                                        <div class="p-2 text-sm text-red-800 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400" role="alert">
                                                {{ $message }}
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="email" placeholder="email" id="email" value="{{$instruktur->email}}"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        @error('email')
                                        <div class="p-2 text-sm text-red-800 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400" role="alert">
                                                {{ $message }}
