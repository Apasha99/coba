...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Daftar Peserta</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="sm:flex mb-4">
        ...
        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
            <a type="button" href ="{{route('admin.createPeserta')}}"
                                            ...
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap searchable">
                                                    ...
                                                    <div class="text-sm font-small text-gray-500 dark:text-gray-400">
                                                        <a class="text-sm font-small text-blue-500 dark:text-blue-500" href="{{route('admin.viewDetailPeserta', $plt->peserta_id)}}">{{ Illuminate\Support\Str::limit($plt->peserta_nama, 30, '...') }}</a>
                                                    </div>
                                                </td>
                                                <td class="p-4 text-sm font-small text-gray-900 whitespace-nowrap dark:text-white searchable">
                                                    {{ $plt->username }}
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap ">
                                                    ...
                                                    <a data-tooltip-target="tooltip-toggle-edit" href="{{ route('admin.editPeserta',[$plt->peserta_id]) }}" class="inline-flex items-center px-2 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                                    ...
                                                    @endif
                                                    <button type="button" data-tooltip-target="tooltip-toggle-delete" data-modal-toggle="delete-peserta-modal-{{ $plt->peserta_id }}"
