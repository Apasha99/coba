                ...
                @foreach ($soal_test as $soal)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-2 py-4 font-medium text-gray-900 text-center whitespace-nowrap dark:text-white">
                            ...
                            @if($soal && $soal->id)
                                <a href="{{route('admin.editSoal', ['plt_kode'=>$test->plt_kode,'test_id'=>$test->id,'soal_id'=>$soal->id])}}" class="inline-flex items-center px-2 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            ...
                            @endif
                                <button type="button" data-modal-toggle="delete-soal-modal"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 overflow">
                                ...
                                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-toggle="delete-soal-modal">
                                ...
                                <div class="p-6 space-y-6 overflow-y-auto">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 w-full dark:text-white p-2" for="delete">Apakah anda yakin ingin menghapus soal beserta semua data jawabannya?</label>
                                    <div class="col-span-full flex justify-between">
                                        <form id="deleteForm" method="POST" action="{{route('admin.deleteSoal', ['plt_kode'=>$test->plt_kode, 'test_id'=>$test->id, 'soal_id'=>$soal->id])}}">
                                            @csrf
                                            @method('DELETE')
                                            <div class="flex">
                                                <button type="submit"
