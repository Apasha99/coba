        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        <button class="dropdown-button text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                        ...
                        <!-- Dropdown -->
                        <div class="dropdown-menu absolute right-0 mt-2 w-56 bg-white border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-50 hidden">
                            ...
                            @foreach ($notif as $nt)
                                <ul class="py-1" role="none">
                                    ...
                                    <li class="ms-3 text-sm font-normal">
                                        <a href="{{ route('peserta.viewDetailPelatihan', ['plt_kode' => $nt->plt_kode]) }}" class="notification-link" data-notification-id="{{ $nt->id }}">
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            notificationLinks.forEach(link => {
                                link.addEventListener('click', function(event) {
                                    ...
                                    // Kirim permintaan AJAX untuk memperbarui isChecked
                                    ...
                                    .then(response => {
                                        if (response.ok) {
                                            // Ubah tampilan notifikasi sesuai kebutuhan
                                            link.classList.add('checked-notification');
                                            // Arahkan pengguna ke rute yang sesuai
