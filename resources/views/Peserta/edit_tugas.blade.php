...
@section('content')
    ...
    <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                <li class="flex items-center">
                    <a href="{{route('peserta.viewDetailTugas', [$pelatihan->kode, $tugas->id])}}"
                        class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Edit Pengumpulan Tugas</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="mb-4 col-span-full xl:mb-2">
        <h3 class="text-l font-semibold text-gray-900 sm:text-l dark:text-white">Tambah pengumpulan tugas</h3>
    </div>
    <div class="mb-4 col-span-full xl:mb-2">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    ...
                    @if($submission->submission_file)
                        ...
                        <div class="mt-1 text-sm text-gray-500">
                            File sebelumnya: {{ $file->nama_file }}
                        </div>
                        @endforeach
                    @endif
