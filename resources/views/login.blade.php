                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="flex justify-between">
                            <div></div> <!-- Bagian kosong untuk membuat tautan Lupa Password berada di sebelah kanan -->
                            <a class="text-sm font-small text-blue-500 dark:text-blue-500" href="{{route('forgetpassword')}}">Lupa Password?</a>
                        </div>
